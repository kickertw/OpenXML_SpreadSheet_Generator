...
namespace Utils
{
    public class ExcelGenerator
    {
        ...
        private void GenerateWorkbookStylesPartContent(WorkbookStylesPart workbookStylesPart)
        {
            ...
            CellFormat cellFormat5 = new CellFormat() { NumberFormatId = (UInt32Value)0U, FontId = (UInt32Value)2U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)0U, FormatId = (UInt32Value)1U };
        ...
        {
            document.PackageProperties.Creator = "Wong PC";
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2015-09-25T19:35:14Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2015-09-25T19:58:12Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = "Wong PC";
        }
